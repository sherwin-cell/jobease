...
<div class="full-page-container">
    <div class="content-wrapper">
        ...
        <div class="content-card">
            ...
            <div class="file-info">
                <span class="file-name">📄 {{ basename($application->resume) }}</span>
                <a href="{{ asset('storage/' . $application->resume) }}" target="_blank" class="btn-primary" style="background: #4b5563; padding: 6px 14px;">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
