...
<style>
    ...
    .status-shortlisted { background: #f3e8ff; color: #6b21a5; }
...
<div class="full-page-container">
    <div class="content-wrapper">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div class="stat-value text-blue-600">{{ $applications->where('status', 'reviewing')->count() }}</div>
            ...
            <div class="stat-card">
                <div class="stat-header">
                    <div class="stat-value text-green-600">{{ $applications->whereIn('status', ['interview', 'interview_scheduled'])->count() }}</div>
