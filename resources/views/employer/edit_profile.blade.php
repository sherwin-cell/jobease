                    ...
                    <div class="card-body">
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <span
                                    class="info-value">{{ $company->company_name ?? '<span class="empty-value">Not set</span>' }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span
                                    class="info-value">{{ $company->location ?? '<span class="empty-value">Not set</span>' }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span
                                    class="info-value">{{ $company->phone ?? '<span class="empty-value">Not set</span>' }}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="info-item info-item-full" style="margin-top: 8px;">
                            ...
                            <p class="description-text">
                                {{ $company->description ?? '<span class="empty-value">Not set</span>' }}</p>
                        </div>
                                ...
                                <span class="info-value">
                                    @if($company->business_permit_path ?? false)
                                        <div class="current-file" style="margin-top: 8px;">
                                            ...
                                            <a href="{{ Storage::url($company->business_permit_path) }}" target="_blank"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location" class="form-input"
                                    value="{{ old('location', $company->location) }}" placeholder="Enter location">
                            </div>
