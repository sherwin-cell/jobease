...
<style>
    ...
    .contact-icon.phone svg { color: #15803d; }
    .contact-icon.location { background: #fef3c7; }
    .contact-icon.location svg { color: #b45309; }
    .contact-icon.website { background: #f3e8ff; }
    .contact-icon.website svg { color: #6b21a5; }
    .contact-icon.member { background: #e0e7ff; }
    .contact-icon.member svg { color: #4338ca; }
    .contact-label {
        font-size: 0.6875rem;
        font-weight: 500;
...
<div class="full-page-container">
    <div class="content-wrapper">
        ...
        <div class="page-header">
            ...
            <a href="{{ route('jobseeker.profile.edit') }}" class="btn-outline">
