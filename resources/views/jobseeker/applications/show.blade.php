                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            {{ $application->job->salary ? '$' . number_format($application->job->salary) . '/year' : 'Negotiable' }}
                        </div>
                    </div>
                    <div class="info-item">
                ...
                <div class="card">
                    ...
                    <div class="match-card">
                        ...
                        <div class="progress-bar">
                            <div class="progress-fill"
                                style="width: {{ $matchPercentage }}%; background: {{ $matchLevel === 'high' ? '#10b981' : ($matchLevel === 'medium' ? '#f59e0b' : '#ef4444') }};">
                            </div>
                        </div>
                    ...
                    @if(!empty($candidateSkillsList))
                        <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #e2e8f0;">
                            <div class="info-label" style="margin-bottom: 0.5rem;">Your Skills ({{ count($candidateSkillsList) }})
                            </div>
                            <div class="skills-container">
                        ...
                        <div style="margin-top: 1rem; padding: 0.75rem; background: #fffbeb; border-radius: 12px;">
                            ...
                            <div class="skills-container">
                                @foreach($missingSkillsList as $skill)
                                    <span
                                        style="background: #fef3c7; color: #92400e; padding: 0.25rem 0.75rem; border-radius: 6px; font-size: 0.7rem;">
                                        {{ ucfirst($skill) }}
                                    </span>
                                @endforeach
                            </div>
                    ...
                    <div class="resume-card">
                        <div class="resume-info">
                            ...
                            <div>
                                ...
                                <p style="font-size: 0.7rem; color: #64748b; margin: 0;">Uploaded on
                                    {{ $application->created_at->format('M d, Y') }}</p>
                            </div>
                        </div>
                        @if($application->resume && str_starts_with($application->resume, 'http'))
                            <a href="{{ $application->resume }}" target="_blank" class="btn-primary" style="background: #475569;">
                        ...
                        @elseif($application->resume)
                            <span style="color: #94a3b8; font-size: 0.75rem; font-style: italic;">
                                Old resume — please resubmit
                            </span>
                        @else
                            <span style="color: #94a3b8; font-size: 0.75rem; font-style: italic;">
                                No resume uploaded
